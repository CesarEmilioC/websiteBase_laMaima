...
update public.site_content set value_en = jsonb_build_object(
  ...
  'gallery', jsonb_build_array(
    jsonb_build_object('url', 'https://mauolzwhergekdvigmaf.supabase.co/storage/v1/object/public/gallery/sitio/sobre-la-reserva.jpg', 'alt', 'The Cauca Valley seen from La Maima, with the forest of the reserve in the foreground'),
    jsonb_build_object('url', 'https://mauolzwhergekdvigmaf.supabase.co/storage/v1/object/public/gallery/sitio/bosque.jpg', 'alt', 'Inside the reserve''s forest, with ferns and tall moss-covered trees'),
    jsonb_build_object('url', 'https://mauolzwhergekdvigmaf.supabase.co/storage/v1/object/public/gallery/experiencias/piscina-de-rio/1.jpg', 'alt', 'A cold-water stream with natural pools among the rocks of the reserve'),
    jsonb_build_object('url', 'https://mauolzwhergekdvigmaf.supabase.co/storage/v1/object/public/gallery/experiencias/avistamiento-de-flora-y-fauna/1.jpg', 'alt', 'An emerald toucanet perched on a branch in the forest at La Maima'),
    jsonb_build_object('url', 'https://mauolzwhergekdvigmaf.supabase.co/storage/v1/object/public/gallery/sitio/senderos.jpg', 'alt', 'An earth trail running through the restored forest of the reserve')
  )
...
update public.site_content set value_en = jsonb_build_object(
  'gallery', jsonb_build_array(
    jsonb_build_object('url', 'https://mauolzwhergekdvigmaf.supabase.co/storage/v1/object/public/gallery/sitio/sobre-la-reserva.jpg', 'alt', 'The Cauca Valley seen from the gardens at La Maima, under a cloudy sky'),
    jsonb_build_object('url', 'https://mauolzwhergekdvigmaf.supabase.co/storage/v1/object/public/gallery/alojamientos/mirador/2.jpg', 'alt', 'The panoramic window at Mirador, open onto the forest and the valley'),
    jsonb_build_object('url', 'https://mauolzwhergekdvigmaf.supabase.co/storage/v1/object/public/gallery/experiencias/avistamiento-de-flora-y-fauna/1.jpg', 'alt', 'An emerald toucanet perched on a branch in the forest of the reserve'),
    jsonb_build_object('url', 'https://mauolzwhergekdvigmaf.supabase.co/storage/v1/object/public/gallery/alojamientos/mirador/5.jpg', 'alt', 'The terrace at Mirador with a hammock hung facing the mountain'),
    jsonb_build_object('url', 'https://mauolzwhergekdvigmaf.supabase.co/storage/v1/object/public/gallery/experiencias/piscina-de-rio/1.jpg', 'alt', 'A cold-water stream with natural pools among the rocks of the forest'),
    jsonb_build_object('url', 'https://mauolzwhergekdvigmaf.supabase.co/storage/v1/object/public/gallery/alojamientos/casa-maima/1.jpg', 'alt', 'The front of Casa Maima with its blue roof and its garden of tropical plants')
  )
