...
--   * Fotos: descargadas del sitio Wix actual (baja resolución en algunos
--     casos) y servidas desde website/public/images. Se reemplazan cuando el
--     cliente envíe las fotos reales (irán a Supabase Storage).
...
(
  ...
  '[{"url":"/images/casa-maima-1.jpg","alt":"Casa Maima vista desde el jardín, con base en piedra y grandes ventanales"},
    {"url":"/images/casa-maima-2.jpg","alt":"Entrada de Casa Maima con techo azul y camino de piedra entre la vegetación"},
    {"url":"/images/vista-valle.jpg","alt":"Vista al Valle del Cauca desde los jardines de La Maima"},
    {"url":"/images/bosque-1.png","alt":"Bosque en rehabilitación que rodea la Casa Maima"}]'::jsonb,
  true, 1
),
(
  'mirador',
  ...
  '[{"url":"/images/mirador-1.jpg","alt":"Cabaña Mirador con terraza privada frente a la ladera de bosque"},
    {"url":"/images/bosque-1.png","alt":"Ladera de bosque nativo vista desde la cabaña Mirador"},
    {"url":"/images/vista-valle.jpg","alt":"Vista al Valle del Cauca desde La Maima"}]'::jsonb,
  true, 2
),
(
  'casa-loma',
  ...
  '[{"url":"/images/casa-loma-1.jpg","alt":"Casa Loma rodeada de jardines, con ventanales de madera"},
    {"url":"/images/senderos-1.png","alt":"Jardines y senderos de La Maima con vista al valle"},
    {"url":"/images/rio-1.jpg","alt":"Quebrada de aguas claras dentro de la reserva La Maima"}]'::jsonb,
  true, 3
),
(
  'casa-uba',
  ...
  '[{"url":"/images/casa-uba-1.jpg","alt":"Casa Uba con su balcón corrido sobre la ladera"},
    {"url":"/images/vista-valle.jpg","alt":"Vista al Valle del Cauca desde los jardines de La Maima"},
    {"url":"/images/bosque-1.png","alt":"Bosque nativo de las montañas de Dapa"}]'::jsonb,
  true, 4
),
(
  'dos-casitas',
  ...
  '[{"url":"/images/dos-casitas-1.jpg","alt":"Cabaña Dos Casitas con terraza cubierta bajo los árboles"},
    {"url":"/images/rio-1.jpg","alt":"Quebrada de aguas claras a pocos pasos de Dos Casitas"},
    {"url":"/images/senderos-1.png","alt":"Senderos y jardines de la reserva La Maima"}]'::jsonb,
  true, 5
),
(
  'tres-casitas',
  ...
  '[{"url":"/images/tres-casitas-1.jpg","alt":"Tres Casitas con su corredor de madera y pérgola"},
    {"url":"/images/senderos-1.png","alt":"Jardines y senderos de La Maima al atardecer"},
    {"url":"/images/bosque-1.png","alt":"Bosque en rehabilitación en las montañas de Dapa"}]'::jsonb,
  true, 6
)
...
(
  ...
  '[{"url":"/images/senderos-1.png","alt":"Sendero entre los jardines de La Maima con vista al Valle del Cauca"}]'::jsonb,
  true, 1
),
(
  'fogata',
  ...
  '[{"url":"/images/fogata.png","alt":"Fogata encendida en la zona común de La Maima al anochecer"}]'::jsonb,
  true, 2
),
(
  'piscina-de-rio',
  ...
  null, null, 'Incluida en la estadía',
  '[{"url":"/images/rio-1.jpg","alt":"Piscina natural formada por la quebrada entre piedras dentro de la reserva"}]'::jsonb,
  true, 3
),
(
  ...
  null, null, 'Incluida en la estadía',
  '[{"url":"/images/bosque-1.png","alt":"Dosel del bosque nativo en las montañas de Dapa, hábitat de la fauna de la reserva"}]'::jsonb,
  true, 4
)
on conflict (slug) do update set
  name              = excluded.name,
